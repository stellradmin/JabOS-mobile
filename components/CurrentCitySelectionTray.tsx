...
interface CurrentCitySelectionTrayProps {
  isVisible: boolean;
  onClose: () => void;
...
// Built-in cities for current location selection
...
const CurrentCitySelectionTray: React.FC<CurrentCitySelectionTrayProps> = ({
  isVisible,
  onClose,
  onConfirmLocation,
  initialLocation = "",
  ...
  const handleConfirm = async () => {
    if (!selectedLocation) {
      ...
      Alert.alert(
        "Select Location",
        "Please select a city from the list to enable distance-based matching.",
...
export default CurrentCitySelectionTray;
